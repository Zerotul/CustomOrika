...
public class ClassMap<A, B> implements MappedTypePair<A, B>{
    ...
    private final ClassMapFilter<? super A, ? super B> filter;
    ...
    public ClassMap(Type<A> aType, Type<B> bType, Set<FieldMap> fieldsMapping, Mapper<A, B> customizedMapper, Set<MapperKey> usedMappers,
            String[] constructorA, String[] constructorB, Boolean sourcesMappedOnNull, Boolean destinationsMappedOnNull, Boolean favorsExtension, ClassMapFilter<? super A, ? super B> filter) {
        this.aType = aType;
        this.bType = bType;
    ...
    public ClassMap<A,B> copy(Set<FieldMap> fieldsMapping) {
        ...
        return new ClassMap<A,B>(aType, bType, fieldsMapping, customizedMapper, usedMappers, constructorA, constructorB, sourcesMappedOnNull, destinationsMappedOnNull, favorsExtension, this.filter);
    }

    public ClassMapFilter<? super A, ? super B> getFilter() {
        return filter;
    }
