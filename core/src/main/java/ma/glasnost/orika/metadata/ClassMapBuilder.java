...
public class ClassMapBuilder<A, B> implements MappedTypePair<A, B> {
    ...
    private ClassMapFilter<? super A, ? super B> filter;
    ...
    public ClassMapBuilder setFilter(ClassMapFilter<? super A, ? super B> filter){
        this.filter = filter;
        return this;
    }
    ...
    /**
     * @param favorsExtension true|false indicating whether the class-map defined by this
