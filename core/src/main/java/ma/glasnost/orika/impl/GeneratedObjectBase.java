...
public abstract class GeneratedObjectBase {
    ...
    protected ClassMapFilter classMapFilter;
    ...
    public ClassMapFilter getClassMapFilter() {
        return classMapFilter;
    }

    public void setClassMapFilter(ClassMapFilter classMapFilter) {
